...
def test_summarize_agent_build():
    with patch("src.core.agents.sumarize_agent.LLMFactory.create", return_value=MagicMock()), \
         patch("src.core.agents.sumarize_agent.PromptFactory.get_summarize_prompt", return_value=MagicMock()):
