    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 bg-surface-container-highest text-on-surface px-4 py-2.5 rounded-full font-medium hover:bg-outline-variant/30 transition-colors">
