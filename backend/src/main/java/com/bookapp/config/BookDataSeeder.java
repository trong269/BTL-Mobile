    ...
    public void run(String... args) {
        List<Book> seeds = List.of(
            createBook(
                "Nha Gia Kim",
                "Paulo Coelho",
                "Hanh trinh di tim kho bau va y nghia cua giac mo. Tieu thuyet truyen cam hung ve su can dam theo duoi dinh menh.",
            ...
            createBook(
                "Dac Nhan Tam",
                "Dale Carnegie",
                "Nghe thuat giao tiep va ung xu giup cai thien moi quan he. Cuon sach kinh dien ve ky nang song va lanh dao.",
            ...
            createBook(
                ...
                "Daniel Kahneman",
                "Kham pha co che ra quyet dinh cua bo nao con nguoi. Sach tam ly hoc ve hai he thong tu duy va nhung dinh kien nhan thuc.",
            ...
            createBook(
                ...
                "Benjamin Graham",
                "Nguyen tac dau tu gia tri va quan tri rui ro ben vung. Tai lieu quan trong cho nguoi bat dau va nha dau tu dai han.",
            ...
            createBook(
                "Muon Kiep Nhan Sinh",
                "Nguyen Phong",
                "Nhung cau chuyen ve nhan qua va hanh trinh tinh than. Tac pham duoc doc gia tre yeu thich trong nhieu nam gan day.",
            ...
            createBook(
                ...
                "Cau chuyen cam dong ve tuoi tho va su truong thanh. Mot tac pham nhe nhang nhung day sau sac.",
            ...
            createBook(
                "De Men Phieu Luu Ky",
                "To Hoai",
                "Phieu luu cua De Men cung nhung bai hoc ve tinh ban. Tac pham thieu nhi noi tieng cua van hoc Viet Nam.",
            ...
            createBook(
                ...
                "Rosie Nguyen",
                "Goc nhin thuc te ve hoc tap, lam viec va trai nghiem. Sach truyen dong luc cho nguoi tre trong giai doan dinh huong.",
            ...
            createBook(
                "Khong Gia Dinh",
                "Hector Malot",
                "Hanh trinh cua Remi di tim gia dinh va niem tin. Tieu thuyet kinh dien ve tinh nguoi va y chi song.",
            ...
            createBook(
                ...
                "Arthur Conan Doyle",
                "Nhung vu an ly ky cua tham tu Sherlock Holmes. Tap hop truyen trinh tham day hap dan.",
            ...
            createBook(
                ...
                "Nguyen Van A",
                "Tu hoc Java tu can ban den huong doi tuong. Phu hop cho sinh vien va nguoi moi bat dau lap trinh.",
            ...
            createBook(
                "Clean Code",
                "Robert C. Martin",
                "Nguyen tac viet ma nguon sach va de bao tri. Sach kinh dien cho lap trinh vien mong muon nang cap tu duy.",
            ...
            createBook(
                "Atomic Habits",
                "James Clear",
                "Xay dung thoi quen tot bang nhung thay doi nho moi ngay. Huong dan thuc te de cai thien ban than ben vung.",
            ...
            createBook(
                ...
                "George S. Clason",
                "Bai hoc tai chinh ca nhan duoc ke qua nhung cau chuyen co. Tac pham de doc va de ap dung cho nguoi muon quan ly tien bac.",
